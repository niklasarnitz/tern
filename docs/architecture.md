...
4. SMTP: local drafts/outbox, MIME construction, TLS, reply/reply-all/forward, attachments, and provider-specific Sent handling. Ambiguous delivery cannot be blindly retried.
